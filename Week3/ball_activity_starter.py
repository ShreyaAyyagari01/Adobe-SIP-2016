...
#Ball 2
x1_speed = random.randint(-10,10)
y1_speed = random.randint(-10,10)

x1_location = int(SCREEN_WIDTH/2)
y1_location = int(SCREEN_HEIGHT/2)

#ball2_size = random.randint(10,30)
...
while not done:
    ...
    #Ball 2
    if x1_location >= SCREEN_WIDTH - ball_size or x1_location < ball_size:
        x1_speed = x1_speed * -1

    if y1_location >= SCREEN_HEIGHT - ball_size or y1_location < ball_size:
        y1_speed = y1_speed * -1


   # x1_location += x1_speed
    #y1_location += y1_speed
